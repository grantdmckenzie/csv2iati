 ...
 <body>
  <?php include_once('inc/header.inc'); ?>
    ...
    <div id="register">
		...
		<tr><td class='lbl'>Organization Name*</td><td><input type="text" name="organization" value="<?php echo urldecode($wbuser->org); ?>"></td></tr>
		<tr><td class='lbl'>Organization Reference*</td><td><input type="text" name="reference" value="<?php echo urldecode($wbuser->ref); ?>"></td></tr>
